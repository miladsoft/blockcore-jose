...
namespace UnitTests
{
    public class TestSuite
    {
        ...
        public void EncryptAndDecryptBytes_RSA1_5_A256GCM()
        {
            ...
            string token = JWT.EncodeBytes(BinaryPayload, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A256GCM);
        ...
        public void DecodeHS384()
        {
            ...
            //when
            string json = JWT.Decode(token, Encoding.UTF8.GetBytes(key));
        ...
        public void DecodeRS256_RSAKey()
        {
            ...
            //when
            string json = JWT.Decode(token, PubRsaKey());
        ...
        public void DecodeES256()
        {
            ...
            //when
            string json = JWT.Decode(token, Ecc256Public());
        ...
        public void DecodeES256K()
        {
            ...
            //when
            string json = JWT.Decode(token, ECDSa256KPublic());
        ...
        public void DecodeES256_ECDsaKey()
        {
            ...
            //when
            string json = JWT.Decode(token, ECDSa256Public());
        ...
        public void DecodeES384()
        {
            ...
            //when
            string json = JWT.Decode(token, Ecc384Public());
        ...
        public void DecodeES512()
        {
            ...
            //when
            string json = JWT.Decode(token, Ecc512Public());
        ...
        public void DecodePS256()
        {
            ...
            //when
            string json = JWT.Decode(token, RsaKey.New(PubKey().ExportParameters(false)));
        ...
        [Fact]
        public void DecodePS256_RsaCSP_Key()
        {
            //given
            string token = "eyJhbGciOiJQUzI1NiIsImN0eSI6InRleHRcL3BsYWluIn0.eyJoZWxsbyI6ICJ3b3JsZCJ9.S9xuR-IGfXEj5qsHcMtK-jcj1lezvVstw1AISp8dEQVRNgwOMZhUQnSCx9i1CA-pMucxR-lv4e7zd6h3cYCfMnyv7iuxraxNiNAgREhOT-bkBCZMNgb5t15xEtDSJ3MuBlK3YBtXyVcDDIdKH_Bwj-u363y6LuvZ8FEOGmIK5WSFi18Xjg-ihhvH1C6UzH1G82wrRbX6DyJKqrUnHAg8yzUJVP1AdgjWRt5BKpuYbXSib-MKZZkaE4q_hCb-j25xCzn8Ez8a7PO7p0fDGvZuOk_yzSfvXSavg7iE0GLuUTNv3nQ_xW-rfbrpYeyXNtstoK3JPFpdtORTyH1iIh7VVA";
        ...
        [Fact]
        public void DecodePS256_RSA_Key()
        {
            //given
            string token = "eyJhbGciOiJQUzI1NiIsImN0eSI6InRleHRcL3BsYWluIn0.eyJoZWxsbyI6ICJ3b3JsZCJ9.S9xuR-IGfXEj5qsHcMtK-jcj1lezvVstw1AISp8dEQVRNgwOMZhUQnSCx9i1CA-pMucxR-lv4e7zd6h3cYCfMnyv7iuxraxNiNAgREhOT-bkBCZMNgb5t15xEtDSJ3MuBlK3YBtXyVcDDIdKH_Bwj-u363y6LuvZ8FEOGmIK5WSFi18Xjg-ihhvH1C6UzH1G82wrRbX6DyJKqrUnHAg8yzUJVP1AdgjWRt5BKpuYbXSib-MKZZkaE4q_hCb-j25xCzn8Ez8a7PO7p0fDGvZuOk_yzSfvXSavg7iE0GLuUTNv3nQ_xW-rfbrpYeyXNtstoK3JPFpdtORTyH1iIh7VVA";
        ...
        public void EncodePS256()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PrivKey().ExportParameters(true)), JwsAlgorithm.PS256);
            ...
            Assert.Equal(parts[0], "eyJhbGciOiJQUzI1NiIsInR5cCI6IkpXVCJ9"); //Header is non-encrypted and static text
            Assert.Equal(parts[1], "eyJoZWxsbyI6ICJ3b3JsZCJ9"); //Pyaload is non encrypted and static text
            Assert.Equal(parts[2].Length, 342); //signature size

            Assert.Equal(JWT.Decode(token, RsaKey.New(PubKey().ExportParameters(false))), json);
        }

        [Fact]
        public void EncodePS256_RsaCSP_Key()
        {
            //given
            string json = @"{""hello"": ""world""}";

            //when
            string token = JWT.Encode(json, PrivKey(), JwsAlgorithm.PS256);
            ...
            Assert.Equal(JWT.Decode(token, PubKey()), json);
        }

        [Fact]
        public void EncodePS256_RSA_Key()
        {
            //given
            string json = @"{""hello"": ""world""}";

            //when
            string token = JWT.Encode(json, PrivRsaKey(), JwsAlgorithm.PS256);
        ...
        public void EncodePS384()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PrivKey().ExportParameters(true)), JwsAlgorithm.PS384);
            ...
            Assert.Equal(parts.Length, 3); //Make sure 3 parts
            Assert.Equal(parts[0], "eyJhbGciOiJQUzM4NCIsInR5cCI6IkpXVCJ9"); //Header is non-encrypted and static text
            Assert.Equal(parts[1], "eyJoZWxsbyI6ICJ3b3JsZCJ9"); //Pyaload is non encrypted and static text
            Assert.Equal(parts[2].Length, 342); //signature size
        ...
        public void EncodePS512()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PrivKey().ExportParameters(true)), JwsAlgorithm.PS512);
            ...
            Assert.Equal(parts.Length, 3); //Make sure 3 parts
            Assert.Equal(parts[0], "eyJhbGciOiJQUzUxMiIsInR5cCI6IkpXVCJ9"); //Header is non-encrypted and static text
            Assert.Equal(parts[1], "eyJoZWxsbyI6ICJ3b3JsZCJ9"); //Pyaload is non encrypted and static text
            Assert.Equal(parts[2].Length, 342); //signature size
        ...
        public void EncodeHS256()
        {
            ...
            //when
            string token = JWT.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS256);
            ...
            Assert.Equal(JWT.Decode(token, Encoding.UTF8.GetBytes(key)), json);
        }
        ...
        public void EncodeHS384()
        {
            ...
            //when
            string token = JWT.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS384);
        ...
        public void EncodeHS512()
        {
            ...
            //when
            string token = JWT.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS512);

            //then
            Console.Out.WriteLine("HS512 = {0}", token);

            Assert.Equal(token, "eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJoZWxsbyI6ICJ3b3JsZCJ9.IIif-Hyd8cS2_oqRb_3PzL7IwoIcPUVl_BVvOr6QbJT_x15RyNy2m_tFfUcm6lriqfAnOudqpyN-yylAXu1eFw");
            Assert.Equal(JWT.Decode(token, Encoding.UTF8.GetBytes(key)), json);
        }
        ...
        public void EncodeRS256()
        {
            ...
            //when
            string test = JWT.Encode(json, PrivKey(), JwsAlgorithm.RS256);
            ...
            Assert.Equal(JWT.Decode(test, PubKey()), json);
        }
        ...
        public void EncodeRS256_RSAKey()
        {
            ...
            //when
            string test = JWT.Encode(json, PrivRsaKey(), JwsAlgorithm.RS256);
        ...
        public void EncodeES256()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Private(), JwsAlgorithm.ES256);
            ...
            Assert.Equal(JWT.Decode(token, Ecc256Public()), json);
        }
        ...
        public void EncodeES256_ECDsaKey()
        {
            ...
            //when
            string token = JWT.Encode(json, ECDSa256Private(), JwsAlgorithm.ES256);
        ...
        public void EncodeES256K()
        {
            ...
            //when
            string token = JWT.Encode(json, ECDSa256KPrivate(), JwsAlgorithm.ES256K);
        ...
        public void EncodeES384()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc384Private(), JwsAlgorithm.ES384);
            ...
            Assert.Equal(JWT.Decode(token, Ecc384Public()), json);
        }
        ...
        public void EncodeES512()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc512Private(), JwsAlgorithm.ES512);
            ...
            Assert.Equal(JWT.Decode(token, Ecc512Public()), json);
        }
        ...
        public void Decrypt_RSA_OAEP_256_A128CBC_HS256()
        {
            ...
            //when
            string json = JWT.Decode(token, RsaKey.New(PrivKey().ExportParameters(true)));
        ...
        [Fact]
        public void Decrypt_RSA_OAEP_256_A128CBC_HS256_RsaKey()
        {
            //given
            string token = "eyJhbGciOiJSU0EtT0FFUC0yNTYiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2In0.bje66yTjMUpyGzbt3QvPNOmCmUPowgEmoBHXw-pByhST2VBSs0_67JKDymKW0VpmQC5Qb7ZLC6nNG8YW5pxTZDOeTQLodhAvzoNAsrx4M2R_N58ZVqBPLKTq7FKi1NNd8oJ80dwWbOJ13dkLH68SlhOK5bhqKFgtbzalnglL2kq8Fki1GkN4YyFnS8-chC-mlrS5bJrPSHUF7oAsG_flL_e9-KzYqYTQgGCB3GYSo_pgalsp2rUO3Oz2Pfe9IEJNlX7R9wOT1nTT0UUg-lSzQ2oOaXNvNyaPgEa76mJ1nk7ZQq7ZNix1m8snjk0Vizd8EOFCSRyOGcp4mHMn7-s00Q.tMFMCdFNQXbhEnwE6mP_XQ.E_O_ZBtJ8P0FvhKOV_W98oxIySDgdd0up0c8FAjo-3OVZ_6XMEQYFDKVG_Zc3zkbaz1Z2hmc7D7M28RbhRdya3yJN6Hcv1KuXeZ9ociI7o739Ni_bPvv8xCmGxlASS5AF7N4JR7XjrWL-SYKGNL1p0XNTlPo3B3qYqgAY6jFNvlcjWupim-pQbWKNqPbO2KmSCtUzyKE5oHjsomH0hnQs0_DXv3cgQ_ZFLFZBc1tC4AjQ8QZex5kWg5BmlJDM5F_jD7QRhb7B1u4Mi563-AKVA.0lraw3IXMM6wPqUZVYA8pg";
            ...
            string json = JWT.Decode(token, PrivRsaKey());
        ...
        [Fact]
        public void Decrypt_RSA_OAEP_256_A128CBC_HS256_RsaCryptoProvider()
        {
            //given
            string token = "eyJhbGciOiJSU0EtT0FFUC0yNTYiLCJlbmMiOiJBMTI4Q0JDLUhTMjU2In0.bje66yTjMUpyGzbt3QvPNOmCmUPowgEmoBHXw-pByhST2VBSs0_67JKDymKW0VpmQC5Qb7ZLC6nNG8YW5pxTZDOeTQLodhAvzoNAsrx4M2R_N58ZVqBPLKTq7FKi1NNd8oJ80dwWbOJ13dkLH68SlhOK5bhqKFgtbzalnglL2kq8Fki1GkN4YyFnS8-chC-mlrS5bJrPSHUF7oAsG_flL_e9-KzYqYTQgGCB3GYSo_pgalsp2rUO3Oz2Pfe9IEJNlX7R9wOT1nTT0UUg-lSzQ2oOaXNvNyaPgEa76mJ1nk7ZQq7ZNix1m8snjk0Vizd8EOFCSRyOGcp4mHMn7-s00Q.tMFMCdFNQXbhEnwE6mP_XQ.E_O_ZBtJ8P0FvhKOV_W98oxIySDgdd0up0c8FAjo-3OVZ_6XMEQYFDKVG_Zc3zkbaz1Z2hmc7D7M28RbhRdya3yJN6Hcv1KuXeZ9ociI7o739Ni_bPvv8xCmGxlASS5AF7N4JR7XjrWL-SYKGNL1p0XNTlPo3B3qYqgAY6jFNvlcjWupim-pQbWKNqPbO2KmSCtUzyKE5oHjsomH0hnQs0_DXv3cgQ_ZFLFZBc1tC4AjQ8QZex5kWg5BmlJDM5F_jD7QRhb7B1u4Mi563-AKVA.0lraw3IXMM6wPqUZVYA8pg";
        ...
        public void Encrypt_RSA_OAEP_256_A128GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PubKey().ExportParameters(false)), JweAlgorithm.RSA_OAEP_256, JweEncryption.A128GCM);
            ...
            Assert.Equal(JWT.Decode(token, RsaKey.New(PrivKey().ExportParameters(true))), json);
        }

        [Fact]
        public void Encrypt_RSA_OAEP_256_A128GCM_RsaKey()
        {
            //given
            string json = @"{""hello"": ""world""}";
            ...
            //when
            string token = JWT.Encode(json, PubRsaKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A128GCM);

            //then
            Console.Out.WriteLine("RSA_OAEP_256_A128GCM(RSA key)={0}", token);
        ...
        public void Encrypt_RSA_OAEP_256_A128GCM_RsaCSPKey()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_256_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PubKey().ExportParameters(false)), JweAlgorithm.RSA_OAEP_256, JweEncryption.A192GCM);
        ...
        public void Encrypt_RSA_OAEP_256_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PubKey().ExportParameters(false)), JweAlgorithm.RSA_OAEP_256, JweEncryption.A256GCM);
        ...
        public void Encrypt_RSA_OAEP_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_RSA_OAEP_A192CBC_HS384()
        {
            ...
            //when
            string token = JWT.Encode(payload, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A192CBC_HS384);
        ...
        public void Encrypt_RSA_OAEP_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(payload, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A256CBC_HS512);
        ...
        public void Encrypt_RSA1_5_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_RSA1_5_A192CBC_HS384()
        {
            ...
            //when
            string token = JWT.Encode(payload, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A192CBC_HS384);
        ...
        public void Encrypt_RSA1_5_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A256CBC_HS512);
        ...
        [Fact]
        public void Decrypt_RSA_OAEP_A128GCM_RSAKey()
        {
            //given
            string token = "eyJhbGciOiJSU0EtT0FFUCIsImVuYyI6IkExMjhHQ00ifQ.Izae78a1L2Z0ai_aYbvVbWjiZwz3DTlD27c4Jh44SZAz7T_w7GHiWGuxa4CYPq4Ul_9i5qpdUK1WJOTxlL8C-TXbWzxgwhs-DdmkRBmI5JWozc6RIYz2ddYBIPDTpOSbg_nwVzCUkqId6PwATSPiYjLY0ZwsSung1JGuSKU5WHzdCLh8cXKFdSNo4PA6xxuIFqDWNeshSvbUhK-xPL_ySPSLGtMfzUocPi--SDnc867a92WZpnCwLbpAqlGcj1u-nrpXjlTdECbZbPH5mggnIU8Xrzi6OIRTf2RPOxk2nYcW-KkzsERSUUmoIStaTnnq6MzRLKdF-eOolVaPEB94tQ.dBju23LfGAmbhKQl.l-hxA-_Jj9X-Kbq6W_7XNSxeeDaZc_YFoHRIBclWn2ebd_1qbZ3Td8aPsxBwe4Mc0KP7JdTnDXH53ajtdo2CQaPIaxNh-ffZkUZCi7o-tM_SRyt1MkUnoxQ5ib4i5lzJNEJyklf7lHQhjUhUa2FKTS1KJvLo0uChw5Gb-Y_7S_BUfOzTDCFQR4XFbpd7ngCWww4skpHEulhBhSr66RGog4wwac_ucfSTKeKxZw0UhHBIZFIAju4zcoN8Abh23JHh0VETiA.FFFvIyv5vq_cE1xIPYn6Wg";
        ...
        [Fact]
        public void Decrypt_RSA_OAEP_A128GCM_CngKey()
        {
            //given
            string token = "eyJhbGciOiJSU0EtT0FFUCIsImVuYyI6IkExMjhHQ00ifQ.Izae78a1L2Z0ai_aYbvVbWjiZwz3DTlD27c4Jh44SZAz7T_w7GHiWGuxa4CYPq4Ul_9i5qpdUK1WJOTxlL8C-TXbWzxgwhs-DdmkRBmI5JWozc6RIYz2ddYBIPDTpOSbg_nwVzCUkqId6PwATSPiYjLY0ZwsSung1JGuSKU5WHzdCLh8cXKFdSNo4PA6xxuIFqDWNeshSvbUhK-xPL_ySPSLGtMfzUocPi--SDnc867a92WZpnCwLbpAqlGcj1u-nrpXjlTdECbZbPH5mggnIU8Xrzi6OIRTf2RPOxk2nYcW-KkzsERSUUmoIStaTnnq6MzRLKdF-eOolVaPEB94tQ.dBju23LfGAmbhKQl.l-hxA-_Jj9X-Kbq6W_7XNSxeeDaZc_YFoHRIBclWn2ebd_1qbZ3Td8aPsxBwe4Mc0KP7JdTnDXH53ajtdo2CQaPIaxNh-ffZkUZCi7o-tM_SRyt1MkUnoxQ5ib4i5lzJNEJyklf7lHQhjUhUa2FKTS1KJvLo0uChw5Gb-Y_7S_BUfOzTDCFQR4XFbpd7ngCWww4skpHEulhBhSr66RGog4wwac_ucfSTKeKxZw0UhHBIZFIAju4zcoN8Abh23JHh0VETiA.FFFvIyv5vq_cE1xIPYn6Wg";
        ...
        public void Encrypt_RSA_OAEP_A128GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_A128GCM_RsaKey()
        {
            ...
            //when
            string token = JWT.Encode(json, PubRsaKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_A128GCM_CngKey()
        {
            ...
            //when
            string token = JWT.Encode(json, RsaKey.New(PubKey().ExportParameters(false)), JweAlgorithm.RSA_OAEP, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A192GCM);
        ...
        public void Encrypt_RSA_OAEP_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A256GCM);
        ...
        public void Encrypt_RSA_OAEP_A256GCM_DEFLATE()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A256GCM, JweCompression.DEF);
        ...
        public void Encrypt_RSA_OAEP_A128GCM_ExtraHeaders()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A128GCM, extraHeaders: extra);
        ...
        public void Encrypt_RSA1_5_A128GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA1_5_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A192GCM);
        ...
        public void Encrypt_RSA1_5_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, PubKey(), JweAlgorithm.RSA1_5, JweEncryption.A256GCM);
        ...
        public void Decrypt_DIR_A128GCM()
        {
            ...
            //when
            string json = JWT.Decode(token, aes128Key);
        ...
        public void Decrypt_DIR_A192GCM()
        {
            ...
            //when
            string json = JWT.Decode(token, aes192Key);
        ...
        public void Decrypt_DIR_A256GCM()
        {
            ...
            //when
            string json = JWT.Decode(token, aes256Key);
        ...
        public void Decrypt_ECDH_ES_A128CBC_HS256()
        {
            ...
            //when
            string json = JWT.Decode(token, Ecc256Private(CngKeyUsages.KeyAgreement));
        ...
        public void Encrypt_PBES2_HS256_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, "top secret", JweAlgorithm.PBES2_HS256_A128KW, JweEncryption.A128CBC_HS256);
            ...
            Assert.Equal(JWT.Decode(token, "top secret"), json);
        }
        ...
        public void Encrypt_PBES2_HS256_A128KW_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, "top secret", JweAlgorithm.PBES2_HS256_A128KW, JweEncryption.A256GCM);
        ...
        public void Encrypt_PBES2_HS384_A192KW_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, "top secret", JweAlgorithm.PBES2_HS384_A192KW, JweEncryption.A192GCM);
        ...
        public void Encrypt_PBES2_HS512_A256KW_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(json, "top secret", JweAlgorithm.PBES2_HS512_A256KW, JweEncryption.A256CBC_HS512);
        ...
        public void Encrypt_A128GCMKW_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, aes128Key, JweAlgorithm.A128GCMKW, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_A128GCMKW_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(json, aes128Key, JweAlgorithm.A128GCMKW, JweEncryption.A256CBC_HS512);
        ...
        public void Encrypt_A192GCMKW_A192CBC_HS384()
        {
            ...
            //when
            string token = JWT.Encode(json, aes192Key, JweAlgorithm.A192GCMKW, JweEncryption.A192CBC_HS384);
            ...
            Assert.Equal(JWT.Decode(token, aes192Key), json);
        }
        ...
        public void Encrypt_A256GCMKW_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(json, aes256Key, JweAlgorithm.A256GCMKW, JweEncryption.A256CBC_HS512);
            ...
            Assert.Equal(JWT.Decode(token, aes256Key), json);
        }
        ...
        public void Encrypt_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, aes128Key, JweAlgorithm.A128KW, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_ECDH_ES_A128KW_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES_A128KW, JweEncryption.A128CBC_HS256);
            ...
            Assert.Equal(JWT.Decode(token, Ecc256Private(CngKeyUsages.KeyAgreement)), json);
        }
        ...
        public void Encrypt_ECDH_ES_A192KW_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES_A192KW, JweEncryption.A192GCM);
        ...
        public void Encrypt_ECDH_ES_A256KW_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES_A256KW, JweEncryption.A256GCM);
        ...
        public void Encrypt_ECDH_ES_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_ECDH_ES_A128GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A128GCM);
        ...
        public void Encrypt_ECDH_ES_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A192GCM);
        ...
        public void Encrypt_ECDH_ES_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, Ecc256Public(CngKeyUsages.KeyAgreement), JweAlgorithm.ECDH_ES, JweEncryption.A256GCM);
        ...
        public void Encrypt_A192KW_A192CBC_HS384()
        {
            ...
            //when
            string token = JWT.Encode(json, aes192Key, JweAlgorithm.A192KW, JweEncryption.A192CBC_HS384);
        ...
        public void Encrypt_A256KW_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(json, aes256Key, JweAlgorithm.A256KW, JweEncryption.A256CBC_HS512);
        ...
        public void Decrypt_DIR_A192CBC_HS384()
        {
            ...
            //when
            string json = JWT.Decode(token, aes384Key);
        ...
        public void Decrypt_DIR_A256CBC_HS512()
        {
            ...
            //when
            string json = JWT.Decode(token, aes512Key);
        ...
        public void Encrypt_DIR_A128GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, aes128Key, JweAlgorithm.DIR, JweEncryption.A128GCM);
        ...
        public void Encrypt_DIR_A256GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, aes256Key, JweAlgorithm.DIR, JweEncryption.A256GCM);
        ...
        public void Encrypt_DIR_A192GCM()
        {
            ...
            //when
            string token = JWT.Encode(json, aes192Key, JweAlgorithm.DIR, JweEncryption.A192GCM);
        ...
        public void Encrypt_DIR_A128CBC_HS256()
        {
            ...
            //when
            string token = JWT.Encode(json, aes256Key, JweAlgorithm.DIR, JweEncryption.A128CBC_HS256);
        ...
        public void Encrypt_DIR_A192CBC_HS384()
        {
            ...
            //when
            string token = JWT.Encode(json, aes384Key, JweAlgorithm.DIR, JweEncryption.A192CBC_HS384);
            ...
            Assert.Equal(JWT.Decode(token, aes384Key), json);
        }
        ...
        public void Encrypt_DIR_A256CBC_HS512()
        {
            ...
            //when
            string token = JWT.Encode(json, aes512Key, JweAlgorithm.DIR, JweEncryption.A256CBC_HS512);
            ...
            Assert.Equal(JWT.Decode(token, aes512Key), json);
        }
        ...
        public void Encrypt_DIR_A256CBC_HS512_DEFLATE()
        {
            ...
            //when
            string token = JWT.Encode(json, aes512Key, JweAlgorithm.DIR, JweEncryption.A256CBC_HS512, JweCompression.DEF);
        ...
        public void EncodeWithDetachedContent()
        {
            ...
            //when
            string token = JWT.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS256, options: new JwtOptions { DetachPayload = true });
        ...
        public void EncodeWithUnencodedPayload()
        {
            ...
            //when
            string token = JWT.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS256, options: new JwtOptions { EncodePayload = false });
        ...
        public void EncodeWithUnencodedAndDetachedContent()
        {
            ...
            //when
            string token = JWT.Encode(json, Encoding.UTF8.GetBytes(key), JwsAlgorithm.HS256, options: new JwtOptions { DetachPayload = true, EncodePayload = false });
        ...
        public void DecodeBytesUnencodedDetached()
        {
            ...
            //when
            byte[] test = JWT.DecodeBytes(token, PubKey(), payload: BinaryPayload);
        ...
        public void DecodeSignedTokenValidationSuccess()
        {
            ...
            // when
            string json = JWT.Decode(token, PubKey(), JwsAlgorithm.RS256);
        ...
        public void DecodeSignedTokenValidationFailure()
        {
            ...
            // then
            Assert.Throws<InvalidAlgorithmException>(() => JWT.Decode(token, PubKey(), JwsAlgorithm.RS512));
        }
        ...
        public void DecodeEncryptedTokenValidationSuccess()
        {
            ...
            // when
            string decodedToken = JWT.Decode(token, RsaKey.New(PrivKey().ExportParameters(true)), JweAlgorithm.RSA_OAEP_256, JweEncryption.A192GCM);
        ...
        public void DecodeEncryptedTokenValidationFailure()
        {
            ...
            // then
            Assert.Throws<InvalidAlgorithmException>(() => JWT.Decode(token, PrivKey(), JweAlgorithm.RSA_OAEP, JweEncryption.A192GCM));
            Assert.Throws<InvalidAlgorithmException>(() => JWT.Decode(token, PrivKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A128CBC_HS256));
        }
        ...
        public void UnknownJwsAlg()
        {
            ...
            //then
            Assert.Throws<InvalidAlgorithmException>(() => JWT.Decode(token, PubKey()));
        }
        ...
        public void UnknownJweAlg()
        {
            ...
            //then
            Assert.Throws<InvalidAlgorithmException>(() => JWT.Decode(token, PrivKey()));
        }
