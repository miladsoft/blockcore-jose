...
namespace UnitTests
{
    public class TestSuite
    {
        ...
        public void EncodePS256()
        {
            ...
            Assert.Equal(Jose.JWT.Decode(token, RsaKey.New(PubKey().ExportParameters(false))), json);
        }
        ...
        public void EncodePS256_RsaCSP_Key()
        {
            ...
            Assert.Equal(Jose.JWT.Decode(token, PubKey()), json);
        }
        ...
        public void EncodePS256_RSA_Key()
        {
            ...
            //when
            string token = Jose.JWT.Encode(json, PrivRsaKey(), JwsAlgorithm.PS256);
        ...
        public void Encrypt_RSA_OAEP_256_A128GCM_RsaKey()
        {
            ...
            //when
            string token = Jose.JWT.Encode(json, PubRsaKey(), JweAlgorithm.RSA_OAEP_256, JweEncryption.A128GCM);
        ...
        public void Encrypt_RSA_OAEP_256_A256GCM()
        {
            ...
            //when
            string token = Jose.JWT.Encode(json, RsaKey.New(PubKey().ExportParameters(false)), JweAlgorithm.RSA_OAEP_256, JweEncryption.A256GCM);
